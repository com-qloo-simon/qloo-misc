...
public class QlooGraphDAO3Test {
	...
	public void printTotalLikeList() {
		...
		List<ChoiceNode> cnList = qgd3.getChoiceNodeLikeList(un);
	...
	public void printLikeList() {
		...
		List<ChoiceNode> cnList = qgd3.getChoiceNodeLikeList(un, false);
	...
	public void printLikeEtherList() {
		...
		List<ChoiceNode> cnList = qgd3.getChoiceNodeLikeList(un, true);
	...
	public void printDislikeList() {
		...
		List<ChoiceNode> cnList = qgd3.getChoiceNodeDislikeList(un);
	...
	public void printFollowList() {
	    ...
	    List<UserNode> followList = qgd3.getUserNodeFollowList(UserNode.newUserNode(uid));
	...
	public void printFollowedList() {
	    ...
	    List<UserNode> followedList = qgd3.getUserNodeFollowedList(UserNode.newUserNode(uid));
